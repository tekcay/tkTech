...
import tkcy.simpleaddon.api.recipes.logic.HeatConsumingLogic;
...
public class BurnerMetatileEntity extends SupplierContainerMetatileEntity implements AdjacentCapabilityHelper, HeatMachine {
    ...
    private HeatConsumingLogic workableHandler;
    private ICubeRenderer renderer;

    public BurnerMetatileEntity(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId);
        this.workableHandler = new HeatConsumingLogic(this, TKCYSARecipeMaps.HEATING_RECIPES);
