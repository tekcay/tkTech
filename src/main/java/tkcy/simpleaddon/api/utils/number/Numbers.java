package tkcy.simpleaddon.api.utils.number;
...
public class Numbers {
    ...
    public static String getQuotientPercentage(int divident, int divisor) {
        return BigDecimal.valueOf(100L * divident)
                .divide(BigDecimal.valueOf(divisor), 1, RoundingMode.UP).toString();
    }
}
