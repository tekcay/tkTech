...
public abstract class MetaTileEntityCleanroomBase extends MultiblockWithDisplayBase
    ...
    protected abstract boolean doesHandleFilter();
    ...
    protected boolean isMachineBanned(MetaTileEntity metaTileEntity) {
        ...
        if (metaTileEntity instanceof MetaTileEntityCleanroomBase) return true;
