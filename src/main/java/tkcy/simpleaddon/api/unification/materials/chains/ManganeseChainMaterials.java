...
public class ManganeseChainMaterials {
    ...
    public static int register(int startId) {
        DimethylOxalate = new Material.Builder(startId++, gregtechId("diethyl_oxalate"))
                .fluid()
                .colorAverage()
        ...
        DiethylOxalate = new Material.Builder(startId++, gregtechId("dimethyl_oxalate"))
                .fluid()
                .colorAverage()
        ...
        DryOxalicAcid = new Material.Builder(startId++, gregtechId("dry_oxalic_acid"))
                .dust()
                .colorAverage()
        ...
        OxalicAcid = new Material.Builder(startId++, gregtechId("oxalic_acid"))
                .dust()
                .colorAverage()
        ...
        CrudeOxalicAcid = new Material.Builder(startId++, gregtechId("crude_oxalic_acid"))
                .dust()
                .colorAverage()
                .components(DryOxalicAcid, 1, Water, 1)
                .build();
        ...
        CrudeDiethylOxalate = new Material.Builder(startId++, gregtechId("crude_diethyl_oxalate"))
                .colorAverage()
                .fluid()
        ...
        CrudeDimethylOxalate = new Material.Builder(startId++, gregtechId("crude_dimethyl_oxalate"))
                .colorAverage()
                .fluid()
        ...
        TreatedSpessartine = new Material.Builder(startId++, gregtechId("treated_spessartine"))
