...
@UtilityClass
public class MoleculeStructureRenderUtils {

    public static TextureArea getMoleculeTexture(Material material) {
       return TextureArea.fullImage(String.format("textures/chemicalstructure/%s.png", material.getResourceLocation().getPath()));
    }
