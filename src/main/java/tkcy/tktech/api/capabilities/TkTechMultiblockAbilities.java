...
public class TkTechMultiblockAbilities {
    ...
    public static final MultiblockAbility<IItemHandlerModifiable> BRICK_BUS_INPUT = new MultiblockAbility<>("brick_bus_input");
    public static final MultiblockAbility<IItemHandlerModifiable> BRICK_BUS_OUTPUT = new MultiblockAbility<>("brick_bus_output");
    public static final MultiblockAbility<IFluidTank> BRICK_HATCH_OUTPUT = new MultiblockAbility<>("brick_hatch_output");
